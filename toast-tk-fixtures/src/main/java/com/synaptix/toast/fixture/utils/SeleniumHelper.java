...
import com.synaptix.toast.fixture.facade.IMiniResult;

/**
 * Helper that helps synchronizing selenium actions to the browser
 * 
 * @author skokaina
 * 
 */
public class SeleniumHelper {
	...
	public static void waitCondition(int retry, int timeMs, IMiniResult condition) {
		try {
	...
	public static WebElement positionSelect(WebDriver driver, IWebElement item) {
		WebElement el = null;
		try {
	...
	public static WebElement singleSelect(WebDriver driver, IWebElement item) {
		switch (item.getMethod()) {
		case CSS:
