<<<<<<< Upstream, based on origin/1.3-rc2
package com.synaptix.toast.plugin.swing.server;

import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.BRING_ON_TOP_DISPLAY;
import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.BUTTON_CLICK;
import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.CHECKBOX_CLICK;
import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.COMBOBOX_CLICK;
import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.KEY_INPUT;
import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.MENU_CLICK;
import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.POPUP_MENU_CLICK;
import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.TABLE_CLICK;
import static com.synaptix.toast.core.interpret.IEventInterpreter.EventType.WINDOW_DISPLAY;
...
public class SwingInspectionRecorder implements IEventRecorder {
	...
	private List<EventCapturedObject> liveRecordedStepsBuffer;

	private EventCapturedObject eventObject;
	...
	private SwingInspectionRecorder(Set<FilteredAWTEventListener> customAwtListeners) {
		...
		this.liveRecordedStepsBuffer = new ArrayList<EventCapturedObject>();
	}
	...
	private void consumeEventLine(EventCapturedObject capturedEvent) {
		...
		eventObject = new EventCapturedObject(container, locator, name, type, value, timeStamp);
	}
...
>>>>>>> f602dec CommandRequest serialisation + whitelist + plugins
