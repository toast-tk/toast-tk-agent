...
public class TestServiceFactory {
	...
	@Inject
	public TestServiceFactory(CommentBlockDaoService.Factory bFactory, TestPageDaoService.Factory tFactory, ConfigBlockDaoService.Factory cFactory, InsertBlockDaoService.Factory iFactory,
			SetupBlockDaoService.Factory sFactory, TestBlockDaoService.Factory tsFactory) {
	...
	public void saveEntity(IBlock entity) {
