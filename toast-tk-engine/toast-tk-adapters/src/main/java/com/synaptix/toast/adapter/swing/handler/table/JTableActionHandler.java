...
public class JTableActionHandler implements ISwingwidgetActionHandler<JTable, String, TableCommandRequest>{
	...
	private String handleSelectMenu(
		final TableCommandRequest command,
	...
	private String handleCountAction(
		JTableFixture tFixture) {
		int tries = 30;
	...
	private String handleDoubleClickAction(
		final TableCommandRequest command,
		JTableFixture tFixture) {
	...
	private String handleFindAction(
		final TableCommandRequest command,
		JTableFixture tFixture) {
