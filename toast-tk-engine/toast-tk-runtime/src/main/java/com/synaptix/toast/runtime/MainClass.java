...
public class MainClass {
	...
	public static void main(
		...
		// TestPageDaoService.Factory factory =
// injector.getInstance(TestPageDaoService.Factory.class);
		// TestPageDaoService testPageService =
// factory.create("test_project_db");
		// ProjectDaoService.Factory pfactory =
// injector.getInstance(ProjectDaoService.Factory.class);
		// ProjectDaoService projectService =
// pfactory.create("test_project_db");
		//
		// CampaignDaoService.Factory cfactory =
// injector.getInstance(CampaignDaoService.Factory.class);
		// CampaignDaoService campaignService =
// cfactory.create("test_project_db");
		...
		// projectService.saveNewIteration(p);
		// List<Project> findAllIterationsByProjectName =
// projectService.findAllIterationsByProjectName("Test project", "v2.0");
