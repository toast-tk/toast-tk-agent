...
public class TestParser {
	...
	private void readAutoSetupBlocks(TestPage testPage, TestPageBlock block, String type) {
	...
	private void readCommentBlock(TestPage testPage, TestPageBlock block) {
	...
	private void readTestBlock(TestPage testPage, TestPageBlock block, BlockLine firstLine) {
	...
	private void readTestPageInclude(TestPage testPage, TestPageBlock block) {
	...
	private void readSetupBlock(TestPage testPage, TestPageBlock block, BlockLine firstLine) {
	...
	private void readInsertBlock(TestPage testPage, TestPageBlock block) {
	...
	private void readSwingPageBlock(TestPage testPage, TestPageBlock block) {
	...
	private void readServiceEntityBlock(TestPage testPage, TestPageBlock block) {
	...
	private void readWebPageBlock(TestPage testPage, TestPageBlock block) {
	...
	public  TestPageBlock handleMultiVarLine(String line, BufferedReader br, TestPageBlock varBlock) throws IOException {
		if (varBlock == null) {
