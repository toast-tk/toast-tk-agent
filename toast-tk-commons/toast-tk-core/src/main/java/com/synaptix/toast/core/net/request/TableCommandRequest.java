...
public class TableCommandRequest extends CommandRequest {
	...
	private TableCommandRequest(
		TableCommandRequestBuilder builder) {
		super(builder);
	...
	public static class TableCommandRequestBuilder extends CommandRequestBuilder {
		...
		public TableCommandRequestBuilder with(
			String item) {
			this.item = item;
			return this;
		}
		...
		public TableCommandRequestBuilder doubleClick(
			String column,
			String value) {
		...
		public TableCommandRequestBuilder selectMenu(
			String menu,
			String column,
			String value) {
