...
public interface IRepositorySetup {
	...
	public TestResult addClass(String className, String testName,
			String searchBy);

	public TestResult addService(String testName, String className);

	public TestResult addDomain(String domainClassName, String domainTestName,
			String tableName);

	public TestResult addProperty(String componentName, String testName,
			String systemName, String componentAssociation);

	public TestResult insertComponent(String entityName2,
