...
import com.synaptix.toast.automation.utils.DriverFactory;
...
import com.synaptix.toast.fixture.utils.SeleniumHelper;
 ...
 * 
 */
public class PortalDriver implements SynchronizedDriver {
	...
	public PortalDriver(WebDriver driver, int defaultRepeat, int defaultTimeout) {
		this.driver = driver;
		if (defaultRepeat > -1) {
